...
#define CONSUMER0_2 USAGE(2), 0x6F, 0x00    // CONSUMER_BRIGHTNESS_UP
#define CONSUMER0_7 USAGE(2), 0x70, 0x00    // CONSUMER_BRIGHTNESS_DOWN
#define CONSUMER1_0 USAGE(1), 0x30          // HID_CONSUMER_POWER

#ifndef CONSUMER0_0
#define CONSUMER0_0   USAGE(1), 0xB5        //   USAGE (Scan Next Track)     ; bit 0: 1
#endif
#ifndef CONSUMER0_1
#define CONSUMER0_1   USAGE(1), 0xB6        //   USAGE (Scan Previous Track) ; bit 1: 2
#endif
#ifndef CONSUMER0_2
#define CONSUMER0_2   USAGE(1), 0xB7        //   USAGE (Stop)                ; bit 2: 4
#endif
#ifndef CONSUMER0_3
#define CONSUMER0_3   USAGE(1), 0xCD        //   USAGE (Play/Pause)          ; bit 3: 8
#endif
#ifndef CONSUMER0_4
#define CONSUMER0_4   USAGE(1), 0xE2        //   USAGE (Mute)                ; bit 4: 16
#endif
#ifndef CONSUMER0_5
#define CONSUMER0_5   USAGE(1), 0xE9        //   USAGE (Volume Increment)    ; bit 5: 32
#endif
#ifndef CONSUMER0_6
#define CONSUMER0_6   USAGE(1), 0xEA        //   USAGE (Volume Decrement)    ; bit 6: 64
#endif
#ifndef CONSUMER0_7
#define CONSUMER0_7   USAGE(2), 0x23, 0x02  //   Usage (WWW Home)            ; bit 7: 128
#endif
#ifndef CONSUMER1_0
#define CONSUMER1_0   USAGE(2), 0x94, 0x01  //   Usage (My Computer) ; bit 0: 1
#endif
#ifndef CONSUMER1_1
#define CONSUMER1_1   USAGE(2), 0x92, 0x01  //   Usage (Calculator)  ; bit 1: 2
#endif
#ifndef CONSUMER1_2
#define CONSUMER1_2   USAGE(2), 0x2A, 0x02  //   Usage (WWW fav)     ; bit 2: 4
#endif
#ifndef CONSUMER1_3
#define CONSUMER1_3   USAGE(2), 0x21, 0x02  //   Usage (WWW search)  ; bit 3: 8
#endif
#ifndef CONSUMER1_4
#define CONSUMER1_4   USAGE(2), 0x26, 0x02  //   Usage (WWW stop)    ; bit 4: 16
#endif
#ifndef CONSUMER1_5
#define CONSUMER1_5   USAGE(2), 0x24, 0x02  //   Usage (WWW back)    ; bit 5: 32
#endif
#ifndef CONSUMER1_6
#define CONSUMER1_6   USAGE(2), 0x83, 0x01  //   Usage (Media sel)   ; bit 6: 64
#endif
#ifndef CONSUMER1_7
#define CONSUMER1_7   USAGE(2), 0x8A, 0x01  //   Usage (Mail)        ; bit 7: 128
#endif
...
BleKeyboard::BleKeyboard(std::string deviceName, std::string deviceManufacturer, uint8_t batteryLevel, BLECharacteristicCallbacks *outputCallbacks) : hid(0)
{
  this->deviceName = deviceName;
  this->deviceManufacturer = deviceManufacturer;
  this->batteryLevel = batteryLevel;
  this->connectionStatus = new BleConnectionStatus();
  this->outputCallbacks = outputCallbacks != NULL ? outputCallbacks : new KeyboardOutputCallbacks();
}
...
void BleKeyboard::taskServer(void* pvParameter) {
  ...
  bleKeyboardInstance->outputKeyboard->setCallbacks(bleKeyboardInstance->outputCallbacks);
