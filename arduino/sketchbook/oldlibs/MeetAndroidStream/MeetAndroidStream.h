/*
  MeetAndroidStream.h - Arduino Library for Amarino
  ...
  History     :
      2013/1/2: Changes to support SoftwareSerial Library by Cooper Maa.
	            Support Arduino Leonardo (not tested) by Cooper Maa.
*/

#ifndef MeetAndroidStream_h
#define MeetAndroidStream_h
...
class MeetAndroidStream : public Print
...
public: 
	// public methods
	MeetAndroidStream(H_voidFuncPtr err);
	MeetAndroidStream(Stream &);
	MeetAndroidStream(void);
